            ...
            <div class="card">
                ...
                <div class="alert alert-danger" id="div_error">
                    <ul>Something Wrong !!</ul>
                        ...
                        <form action="<?php echo e(route('albums.update',$album->id)); ?>"  method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('patch'); ?>
                            <div class="form-group">
                                <label for="name">Album Name</label>
                                <input type="text" name="name" required class="form-control" id="name" value="<?php echo e($album->name); ?>">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LaravelProject\album-task\resources\views/album/edit.blade.php ENDPATH**/ ?>